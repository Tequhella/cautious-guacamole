...
import com.ynov.m2.advanced_software_development.cautious_guacamole.client.controller.ForgotPasswordModalController;
...
public class ForgotPasswordModal {
    ...
    public ForgotPasswordModal() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("forgot-password-modal.fxml"));
            Parent root = loader.load();

            ForgotPasswordModalController controller = loader.getController();
            ...
            Scene scene = new Scene(root, 400, 300);  // Largeur: 400px, Hauteur: 300px
