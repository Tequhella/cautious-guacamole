...
import com.ynov.m2.advanced_software_development.cautious_guacamole.client.controller.ManageRoomModalController;
...
public class ManageRoomModal {
    private Stage stage;

    public ManageRoomModal() {
        try {
            // Charger le fichier FXML de la modal
            FXMLLoader loader = new FXMLLoader(getClass().getResource("manage-room-modal.fxml"));
            Parent root = loader.load();

            ManageRoomModalController controller = loader.getController();
            ...
            stage.setTitle("gestion de la salle");
            ...
            Scene scene = new Scene(root, 450, 350);  // Largeur: 500px, Hauteur: 300px
