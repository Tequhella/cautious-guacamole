...
import com.ynov.m2.advanced_software_development.cautious_guacamole.client.controller.BookingModalController;
...
public class BookingModal {
    ...
    public BookingModal() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("booking-modal.fxml"));
            Parent root = loader.load();

            BookingModalController controller = loader.getController();
            ...
            stage.setTitle("réservation de salle");
            ...
            Scene scene = new Scene(root, 600, 210);  // Largeur: 500px, Hauteur: 300px
