...
import com.ynov.m2.advanced_software_development.cautious_guacamole.client.controller.RoomModalController;
...
public class RoomModal {
    ...
    public RoomModal() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("room-modal.fxml"));
            Parent root = loader.load();

            RoomModalController controller = loader.getController();
            ...
            stage.setTitle("création de salle");
